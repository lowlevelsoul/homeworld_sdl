...
void MissileDestroyerAttackPassive(Ship *ship,Ship *target,bool_t rotate)
{
...
bool_t MissileDestroyerSpecialTarget(Ship *ship,void *custom)
{
    ...
    bool_t firedSomeMissiles,triedToFire;
    vector trajectory;
