...
bool_t gravwellIsShipStuckForHyperspaceing(Ship *ship)
{
...
bool_t GravWellGeneratorSpecialActivate(Ship *ship)
{
    sdword LOD;
    etglod *etgLOD;
    etgeffectstatic *stat;
...
bool_t ShipInGravField(Ship *ship, Ship *objinquestion)
{
    GravWellGeneratorSpec *spec = (GravWellGeneratorSpec *)ship->ShipSpecifics;
    Node *gravnode;
    GravStruct *gravstruct;
