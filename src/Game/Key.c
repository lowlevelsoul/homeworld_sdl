...
bool_t keyAnyKeyHit(void)
{
    ...
    return (bool_t)keyhit.keypressed;
}
...
----------------------------------------------------------------------------*/
udword keyBufferedKeyGet(bool_t *bShift)
{
...
/*-----------------------------------------------------------------------------
    ...
    Return      :
----------------------------------------------------------------------------*/
void keyBufferAdd(udword key, bool_t bShift)
{
    int i;
