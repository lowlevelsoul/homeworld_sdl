...
/*-----------------------------------------------------------------------------
    ...
    Return      :
----------------------------------------------------------------------------*/
bool_t pingListSortCallback(void *firststruct,void *secondstruct)
{
...
----------------------------------------------------------------------------*/
bool_t pingAnomalyPingTimeout(struct ping *hellaPing, SpaceObj *user, char *userData, bool_t bRemoveReferences)
{
...
----------------------------------------------------------------------------*/
bool_t pingBattleBlobCriteria(blob *superBlob, SpaceObj *obj)
{
...
----------------------------------------------------------------------------*/
bool_t pingBattlePingEvaluate(struct ping *hellaPing, SpaceObj *user, char *userData, bool_t bRemoveReferences)
{
    sdword index;
    Ship **thisShip;
...
/*-----------------------------------------------------------------------------
    ...
    Return      : TRUE because this function should only be called when the
                    ping times out
----------------------------------------------------------------------------*/
bool_t pingNewShipCallback(struct ping *hellaPing, SpaceObj *user, char *userData, bool_t bRemoveReferences)
{
    return(TRUE);
}
