...
{
    { (udword)NewAlloys,                strdollar(NewAlloys)},
    { (udword)MassDrive1Kt,             strdollar(MassDrive1Kt)},
    { (udword)CoolingSystems,           strdollar(CoolingSystems)},
    { (udword)CloakDefenseFighter,      strdollar(CloakDefenseFighter)},
    { (udword)TargetingSystems,         strdollar(TargetingSystems)},
    { (udword)PlasmaWeapons,            strdollar(PlasmaWeapons)},
    { (udword)Chassis1,                 strdollar(Chassis1)},
    { (udword)MassDrive10Kt,            strdollar(MassDrive10Kt)},
    { (udword)MediumGuns,               strdollar(MediumGuns)},
    { (udword)MineLayerTech,            strdollar(MineLayerTech)},
    { (udword)Chassis2,                 strdollar(Chassis2)},
    { (udword)AdvancedCoolingSystems,   strdollar(AdvancedCoolingSystems)},
    { (udword)MassDrive100Kt,           strdollar(MassDrive100Kt)},
    { (udword)FireControl,              strdollar(FireControl)},
    { (udword)SupportRefuelTech,        strdollar(SupportRefuelTech)},
    { (udword)AdvanceTacticalSupport,   strdollar(AdvanceTacticalSupport)},
    { (udword)IonWeapons,               strdollar(IonWeapons)},
    { (udword)DDDFDFGFTech,             strdollar(DDDFDFGFTech)},
    { (udword)Chassis3,                 strdollar(Chassis3)},
    { (udword)MassDrive1Mt,             strdollar(MassDrive1Mt)},
    { (udword)AdvancedFireControl,      strdollar(AdvancedFireControl)},
    { (udword)MissileWeapons,           strdollar(MissileWeapons)},
    { (udword)ConstructionTech,         strdollar(ConstructionTech)},
    { (udword)HeavyGuns,                strdollar(HeavyGuns)},
    { (udword)ProximityDetector,        strdollar(ProximityDetector)},
    { (udword)SensorsArrayTech,         strdollar(SensorsArrayTech)},
    { (udword)GravityWellGeneratorTech, strdollar(GravityWellGeneratorTech)},
    { (udword)CloakGeneratorTech,       strdollar(CloakGeneratorTech)},
    { (udword)RepairTech,               strdollar(RepairTech)},
    { (udword)SalvageTech,              strdollar(SalvageTech)},
    { (udword)NumTechnologies,          strdollar(NumTechnologies)},
    { 0,NULL }
};
