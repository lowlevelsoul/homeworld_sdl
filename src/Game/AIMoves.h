...
struct AITeamMove *aimCreateMoveAttack(struct AITeam *team, SelectCommand *targets, bool_t Advanced, TypeOfFormation formation, TacticsType tactics, bool8 wait, bool8 remove);
...
struct AITeamMove *aimCreateMoveTo(struct AITeam *team, vector destination, real32 limiter, udword type, TypeOfFormation formation, TacticsType tactics, bool_t wait, bool_t remove);
...
struct AITeamMove *aimCreateActiveRecon(struct AITeam *team, bool_t EnemyRecon, TypeOfFormation formation,TacticsType tactics, bool8 wait, bool8 remove);
...
struct AITeamMove *aimCreateMoveAttackNoAdd(struct AITeam *team, SelectCommand *targets, bool_t Advanced, TypeOfFormation formation, TacticsType tactics, bool8 wait, bool8 remove);
...
struct AITeamMove *aimCreateMoveToNoAdd(struct AITeam *team, vector destination, real32 limiter, udword type, TypeOfFormation formation, TacticsType tactics, bool_t wait, bool_t remove);
...
struct AITeamMove *aimCreateActiveReconNoAdd(struct AITeam *team, bool_t EnemyRecon, TypeOfFormation formation,TacticsType tactics, bool8 wait, bool8 remove);
...
TI_API AITeamMove *aimCreateMoveToNoAdd(AITeam *team, vector destination, real32 limiter, udword type, TypeOfFormation formation, TacticsType tactics, bool_t wait, bool_t remove);
TI_API AITeamMove *aimCreateMoveTo(AITeam *team, vector destination, real32 limiter, udword type, TypeOfFormation formation, TacticsType tactics, bool_t wait, bool_t remove);
...
TI_API AITeamMove *aimCreateMoveAttackNoAdd(AITeam *team, SelectCommand *targets, bool_t Advanced, TypeOfFormation formation, TacticsType tactics, bool8 wait, bool8 remove);
TI_API AITeamMove *aimCreateMoveAttack(AITeam *team, SelectCommand *targets, bool_t Advanced, TypeOfFormation formation, TacticsType tactics, bool8 wait, bool8 remove);
...
TI_API AITeamMove *aimCreateActiveReconNoAdd(AITeam *team, bool_t EnemyRecon, TypeOfFormation formation, TacticsType tactics, bool8 wait, bool8 remove);
TI_API AITeamMove *aimCreateActiveRecon(AITeam *team, bool_t EnemyRecon, TypeOfFormation formation, TacticsType tactics, bool8 wait, bool8 remove);
