...
{
    bool_t a = univSpaceObjInRenderList((SpaceObj*)chunka->spaceobj);
    bool_t b = univSpaceObjInRenderList((SpaceObj*)chunkb->spaceobj);
...
----------------------------------------------------------------------------*/
bool_t nebIsClipped(nebTendril* tendril)
{
    vector veye, vobj;
