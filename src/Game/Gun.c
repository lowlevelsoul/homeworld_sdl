...
----------------------------------------------------------------------------*/
bool_t gunCanShoot(Ship *ship, Gun *gun)
{
...
----------------------------------------------------------------------------*/
bool_t gunOrientGimbleGun(Ship *ship,Gun *gun,SpaceObjRotImpTarg *target)
{
    GunStatic *gunstatic = gun->gunstatic;
...
/*-----------------------------------------------------------------------------
    ...
    Note        : trajectory can be passed in as NULL for ships that don't have
                  ...
                  fixed guns.
----------------------------------------------------------------------------*/
bool_t gunShootGunsAtTarget(Ship *ship,SpaceObjRotImpTarg *target,real32 range,vector *trajectory)
{
...
/*-----------------------------------------------------------------------------
    ...
    Return      :
----------------------------------------------------------------------------*/
bool_t gunShootGunsAtMultipleTargets(Ship *ship)
{
    GunInfo *gunInfo = ship->gunInfo;
...
----------------------------------------------------------------------------*/
bool_t gunMatrixUpdate(udword flags, hmatrix *startMatrix, hmatrix *matrix, void *data, smemsize ID)
{
    Ship *ship;
    Gun *gun;
    GunStatic *gunstatic;
...
void gunTuneGun(Ship *ship)
{
    ...
    Gun *gun;
    GunStatic *gunstatic;
    bool_t updateguncoordsys = FALSE;
