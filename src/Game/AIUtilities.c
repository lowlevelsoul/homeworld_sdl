...
typedef struct
{
    ...
    bool_t           visibility;
    bool_t           mothership;  //whether or not there is a mothership in this blob
...
----------------------------------------------------------------------------*/
Path *aiuCreatePathStruct(udword numPoints, bool_t closed)
{
    udword i;
...
----------------------------------------------------------------------------*/
bool_t aiuPointIsInFront(vector a, vector b, vector c)
{
...
/*-----------------------------------------------------------------------------
    ...
    Return      : the new path
----------------------------------------------------------------------------*/
Path *aiuGenerateCircularPath(udword num_points, vector center, real32 radius, bool_t closed)
{
    udword i;
    double theta = 0.0;
    vector temp;
...
/*-----------------------------------------------------------------------------
    ...
    Return      : void
----------------------------------------------------------------------------*/
bool_t aiuAlreadyHasShipType(ShipType shiptype, udword num)
{
...
----------------------------------------------------------------------------*/
bool_t aiuRescueShip(ShipPtr ship, struct AITeam *team)
{
...
----------------------------------------------------------------------------*/
bool_t aiuTakeoutShip(ShipPtr ship, struct AITeam *team)
{
    SelectCommand *enemyShips;
    AITeamMove *newMove, *thisMove = team->curMove;
    TypeOfFormation formation;
...
----------------------------------------------------------------------------*/
bool_t aiuShipsNoLongerAttacking(SelectCommand *ships)
{
    CommandToDo *command;
    udword i;
...
----------------------------------------------------------------------------*/
bool_t aiuShipIsAnEnemyMothership(Ship *ship)
{
...
----------------------------------------------------------------------------*/
bool_t aiuShipIsntAnEnemyMothership(Ship *ship)                          //aialliance
{
...
----------------------------------------------------------------------------*/
bool_t aiuAnyShipsAreCapitalShips(SelectCommand *ships)
{
    sdword i;
...
/*-----------------------------------------------------------------------------
    ...
    Return      : void
----------------------------------------------------------------------------*/
bool_t aiuShipIsFighter(Ship *ship)
{
...
----------------------------------------------------------------------------*/
bool_t aiuShipNotGoodAgainstFighters(Ship *ship)
{
...
----------------------------------------------------------------------------*/
bool_t aiuSelectionNotGoodAtKillingTheseTargets(SelectCommand *selection, SelectCommand *targets, real32 strengthratio)
{
    real32 strength = 0;
...
----------------------------------------------------------------------------*/
bool_t aiuShipsAreHidden(SelectCommand *selection)
{
    udword i;
...
----------------------------------------------------------------------------*/
bool_t aiuShipsArentTargetable(SelectCommand *selection)
{
    udword i;
...
----------------------------------------------------------------------------*/
bool_t aiuIsShipDangerous(Ship *ship)
{
...
----------------------------------------------------------------------------*/
bool_t aiuIsShipPrimaryEnemy(Ship *ship)
{
...
----------------------------------------------------------------------------*/
bool_t aiuShipsCloseToEnemyMothership(Player *player, SelectCommand *ships, real32 dist)
{
    blob *shipblob;
...
----------------------------------------------------------------------------*/
bool_t aiuDestinationNotNearOtherMothership(vector destination, real32 radiussq)
{
    Node *node;
    Ship *ship;
...
----------------------------------------------------------------------------*/
bool_t aiuShipIsVulnerableGoodGuy(ShipPtr ship)
{
...
----------------------------------------------------------------------------*/
bool_t aiuShipIsLargeVulnerableGoodGuy(ShipPtr ship)
{
    ShipType shiptype = ship->shiptype;
...
----------------------------------------------------------------------------*/
SelectCommand *aiuFindSwarmTargets(SelectCommand *teamShips, udword numTargets, bool_t harass)
{
...
----------------------------------------------------------------------------*/
bool_t aiuPointWithinSphereOfInfluence(vector point)
{
    vector center;
    real32 radiussq;
...
----------------------------------------------------------------------------*/
bool_t aiuFindDecloakedShipInSphereOfInfluence(void)
{
    udword i, j;
...
----------------------------------------------------------------------------*/
bool_t aiuShipIsResourcingOrSomething(ShipPtr ship)
{
...
----------------------------------------------------------------------------*/
bool_t aiuFindBestResourceBlob(vector *destination)
{
    Node *blobnode = universe.collBlobList.head;
    blob *thisBlob;
    blob *maxBlob = NULL;
...
----------------------------------------------------------------------------*/
bool_t aiuEnemyShipIsVisible(ShipPtr ship)
{
    aiblob *shipblob;
...
----------------------------------------------------------------------------*/
bool_t aiuShipsInGunRangeOfTargets(SelectCommand *selection)
{
...
----------------------------------------------------------------------------*/
bool_t aiuFindArmadaTarget(vector *dest_target, SelectCommand **sel_target, SelectCommand *team_sel)
{
...
bool_t aiuWrapAttack(SelectCommand *attackers, SelectCommand *targets)
{
...
bool_t aiuWrapMove(SelectCommand *ships, vector destination)
{
    MaxSelection filtered;
...
bool_t aiuWrapDock(SelectCommand *ships, DockType docktype, ShipPtr dockwith)
{
    MaxSelection filtered;
...
bool_t aiuKasWrapFormation(SelectCommand *ships, TypeOfFormation formation)
{
    MaxSelection filtered;
...
bool_t aiuWrapFormation(SelectCommand *ships, TypeOfFormation formation)
{
    MaxSelection filtered;
...
bool_t aiuWrapProtect(SelectCommand *ships, SelectCommand *shipstoguard)
{
...
bool_t aiuWrapSpecial(SelectCommand *ships, SelectCommand *targets)
{
    MaxSelection filtered;
...
bool_t aiuWrapCollectResource(SelectCommand *ships, ResourcePtr resource)
{
    MaxSelection filtered;
...
bool_t aiuWrapSetTactics(SelectCommand *ships, TacticsType tactics)
{
    MaxSelection filtered;
...
bool_t aiuWrapSetKamikaze(SelectCommand *ships)
{
    MaxSelection filtered;
...
bool_t aiuWrapHalt(SelectCommand *ships)
{
    MaxSelection filtered;
...
bool_t aiuWrapScuttle(SelectCommand *ships)
{
    MaxSelection filtered;
...
----------------------------------------------------------------------------*/
bool_t aiuFindCloakersInEnemyShipsIAmAwareOf(bool_t Red_Alert)
{
    bool_t change = FALSE;
...
void aiuFillInArrays(blob_array *goodGuy_blob_array, blob_array *enemy_blob_array, Player *player)
{
    ...
    ShipPtr ship;
    udword i;
    bool_t enemyFound = FALSE, goodGuyFound = FALSE, myMothershipFound = FALSE;
