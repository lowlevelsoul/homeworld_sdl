...
//
static void filenameSlashMassage(char *filename, bool_t bLocalPath)
{
    udword i, j;
...
----------------------------------------------------------------------------*/
bool_t bigTOCFileExists(bigTOC *toc, char *filename, udword *fileNum)
{
...
bool_t bigOpenAllBigFiles(void)
{
    udword bigfile_i = 0;
...
bool_t bigFindFile(char *filename, bigFileConfiguration **whereFound, udword *fileIndex)
{
    udword bigfile_i = 0;
