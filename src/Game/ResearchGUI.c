...
bool_t rmExtendedInfoActive = FALSE;

bool_t rmIoSaveState;

uword researchingthistopic;
bool_t multipleresearchersselected;
...
/*-----------------------------------------------------------------------------
    ...
    Return      : bool_t
----------------------------------------------------------------------------*/
bool_t ShipsNeedTech(TechStatics *techstat, TechnologyType tech)
{
    sdword index;
