...
void allianceCancelAttackOrders(uword playerone, uword playertwo)
{
    ...
    while (search != NULL)
    {
        ...
        if ( (todo->ordertype.order == COMMAND_ATTACK) ||
             (todo->ordertype.attributes & COMMAND_MASK_PASSIVE_ATTACKING) )
        {
...
/*-----------------------------------------------------------------------------
    ...
    Return      : bool_t
----------------------------------------------------------------------------*/
bool_t allianceIsShipAlly(Ship *ship, Player *player)
{
...
/*-----------------------------------------------------------------------------
    ...
    Return      : bool_t
----------------------------------------------------------------------------*/
bool_t allianceArePlayersAllied(Player *playerone, Player *playertwo)
{
