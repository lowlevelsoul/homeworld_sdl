...
----------------------------------------------------------------------------*/
bool_t aitrackIsStabilizeShip(Ship *ship)
{
    vector heading,up,right;
    bool_t stabilizedpitch;
...
/*-----------------------------------------------------------------------------
    ...
    Return      :
----------------------------------------------------------------------------*/
bool_t aitrackStabilizeGuidance(SpaceObjRotImpTargGuidance *ship)
{
    real32 rotx = ship->rotinfo.rotspeed.x;
...
----------------------------------------------------------------------------*/
bool_t aitrackIsZeroRotation(Ship *ship)
{
    real32 rotx = ship->rotinfo.rotspeed.x;
    real32 roty = ship->rotinfo.rotspeed.y;
    real32 rotz = ship->rotinfo.rotspeed.z;
...
/*-----------------------------------------------------------------------------
    ...
    Return      :
----------------------------------------------------------------------------*/
bool_t aitrackZeroRotationAnywhere(Ship *ship)
{
    real32 rotx = ship->rotinfo.rotspeed.x;
    real32 roty = ship->rotinfo.rotspeed.y;
    real32 rotz = ship->rotinfo.rotspeed.z;
...
----------------------------------------------------------------------------*/
bool_t aitrackHeadingAndUp(Ship *ship,vector *desiredHeading,vector *desiredUp,real32 accuracy)
{
...
/*-----------------------------------------------------------------------------
    ...
    Return      : TRUE if heading has been successfully tracked.
----------------------------------------------------------------------------*/
bool_t aitrackHeadingFunc(SpaceObjRotImpTargGuidance *ship,vector *desiredHeading,real32 accuracy,real32 upaccuracy,real32 sinbank,udword flags)
{
...
bool_t aitrackHeadingWithBankPitchFunc(Ship *ship,vector *desiredHeading,real32 accuracy,real32 sinbank,real32 pitchdescend,real32 pitchturn,udword flags)
{
    vector curheading;
    vector desheading;
...
/*-----------------------------------------------------------------------------
    ...
    Return      :
----------------------------------------------------------------------------*/
bool_t aitrackRightVector(Ship *ship,vector *desiredRightVector,real32 accuracy)
{
    ShipStaticInfo *shipstaticinfo = (ShipStaticInfo *)ship->staticinfo;
...
----------------------------------------------------------------------------*/
bool_t aitrackIsZeroVelocity(Ship *ship)
{
    vector shipVelocity;
...
bool_t aitrackZeroForwardVelocity(Ship *ship)
{
    ShipStaticInfo *shipstaticinfo = ship->staticinfo;
    real32 thruststr;
    real32 massOverTime;
...
/*-----------------------------------------------------------------------------
    ...
    Return      :
----------------------------------------------------------------------------*/
bool_t aitrackZeroVelocity(Ship *ship)
{
    vector shipVelocity;
    vector shipVelocityInShipCoordSys;
    ShipStaticInfo *shipstaticinfo = (ShipStaticInfo *)ship->staticinfo;
...
/*-----------------------------------------------------------------------------
    ...
    Return      :
----------------------------------------------------------------------------*/
bool_t aitrackSteadyShipDriftOnly(Ship *ship)
{
...
----------------------------------------------------------------------------*/
bool_t aitrackIsShipSteadyAnywhere(Ship *ship)
{
...
/*-----------------------------------------------------------------------------
    ...
    Return      :
----------------------------------------------------------------------------*/
bool_t aitrackSteadyShipAnywhere(Ship *ship)
{
    bool_t stabilized = aitrackZeroRotationAnywhere(ship);
    bool_t zerovel = aitrackZeroVelocity(ship);
...
----------------------------------------------------------------------------*/
bool_t aitrackIsShipSteady(Ship *ship)
{
...
/*-----------------------------------------------------------------------------
    ...
    Return      :
----------------------------------------------------------------------------*/
bool_t aitrackSteadyShip(Ship *ship)
{
    bool_t stabilized = aitrackStabilizeShip(ship);
    bool_t zerovel = aitrackZeroVelocity(ship);
...
----------------------------------------------------------------------------*/
bool_t MoveReachedDestinationVariable(Ship *ship,vector *destination,real32 bounds)
{
    vector lefttogo;
...
/*-----------------------------------------------------------------------------
    ...
    Return      : void
----------------------------------------------------------------------------*/
bool_t aitrackRotationSpeed(Ship *ship, real32 desiredrotspeed, uword track)
{
    real32 rotstr      = 0.0;
