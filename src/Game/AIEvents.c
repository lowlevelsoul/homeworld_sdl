...
sdword aieCheckHealthLow(AITeam *team)
{
    ...
    bool_t watchIndividual = team->curMove->events.healthLow.watchIndividual;
...
sdword aieCheckHealthHigh(AITeam *team)
{
    ...
    bool_t watchIndividual = team->curMove->events.healthHigh.watchIndividual;
...
sdword aieCheckFuelLow(AITeam *team)
{
    ...
    bool_t watchIndividual = team->curMove->events.fuelLow.watchIndividual;
...
sdword aieCheckFuelHigh(AITeam *team)
{
    ...
    real32 maxFuel = 0.0;
    real32 actualFuel = 0.0;
    bool_t watchIndividual = team->curMove->events.fuelHigh.watchIndividual;
