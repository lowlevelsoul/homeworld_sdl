...
bool_t  zoomOutNow = FALSE;
bool_t  zoomInNow  = FALSE;
...
/*-----------------------------------------------------------------------------
    ...
    Return      :
----------------------------------------------------------------------------*/
void cameraZoom(Camera *camera,real32 zoomfactor, bool_t EnforceShipDistances)
{
    real32 minZoom;
...
----------------------------------------------------------------------------*/
sdword cameraControl(Camera *camera, bool_t EnforceShipDistances)
{
    sdword UserAction = 0;
