...
static void MakeExplosionRockBumpables(Ship *ship,bool_t scuttle);
...
/*-----------------------------------------------------------------------------
    ...
    Return      :
----------------------------------------------------------------------------*/
void univInitSpaceObjPosRot(SpaceObj *obj,vector *position,bool_t randomOrientation)
{
...
----------------------------------------------------------------------------*/
Ship *ShipIDtoShip(ShipID shipID,bool_t considerInsideShips)
{
...
----------------------------------------------------------------------------*/
bool_t univAmIInsideThisShip(Ship *me,Ship *ship)
{
    if (ship->shipsInsideMe)
    {
        Node *insidenode = ship->shipsInsideMe->insideList.head;
...
bool_t ObjectsHaveCollidedLately(SpaceObjRotImpTarg *obj1,SpaceObjRotImpTarg *obj2)
{
...
bool_t ShouldDoGlancingCollision(SpaceObjRotImpTarg *fastobj,real32 fastobjvelmag2,SpaceObjRotImpTarg *slowobj,real32 slowobjvelmag2)
{
...
/*-----------------------------------------------------------------------------
    ...
    Return      :
----------------------------------------------------------------------------*/
void MakeExplosionRockBumpables(Ship *ship,bool_t scuttle)
{
...
----------------------------------------------------------------------------*/
bool_t ApplyDamageToTarget(SpaceObjRotImpTarg *target,real32 damagetaken,GunSoundType soundType,sdword damageHow,sdword playerIndex)
{
    bool_t targetWasAlive = ((target->flags & SOF_Dead) == 0);
...
----------------------------------------------------------------------------*/
bool_t univFindBackupMothership(struct Player *player)
{
...
----------------------------------------------------------------------------*/
bool_t DeleteDeadDerelict(Derelict *derelict, sdword deathBy)
{
    Effect *effect;
...
bool_t univObjectOutsideWorld(SpaceObj *obj)
{
...
----------------------------------------------------------------------------*/
bool_t univSpaceObjInRenderList(SpaceObj *spaceobj)
{
...
----------------------------------------------------------------------------*/
bool_t univUpdate(real32 phystimeelapsed)
{
#ifdef _WIN32
