...
typedef struct
{
    ...
    bool_t        locked;     // set when deleting a bunch of stuff so another event doesn't play
...
bool_t    MoShipMoving[MAX_MULTIPLAYER_PLAYERS] = {FALSE};
...
/* externs */
extern bool_t soundpaused;

/* global volume settings */
extern real32 volSpeech;
extern real32 volMusic;
extern real32 volNIS;
extern bool_t bVolMusicNoFade;

/* global speech settings */
extern bool_t bActorOn[];
extern bool_t bCommandsOn;
extern bool_t bStatusOn;
extern bool_t bChatterOn;
...
extern bool_t nearestShipMoving;

extern bool_t FalkosFuckedUpTutorialFlag;
...
----------------------------------------------------------------------------*/
sdword speechEventStop(sdword handle, real32 fadetime, bool_t addstatic)
{
...
sdword SEspeechevent(sdword stream, sdword actor, sdword event, sdword var, sword vol, sword pan, double dist, float damageratio, sdword setVariation, bool_t bookend, ShipClass shipclass)
{
    udword duration = 0;
    udword variation = 0;
#if SPEECH
