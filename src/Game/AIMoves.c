...
/*-----------------------------------------------------------------------------
    ...
    Return      : the new move
----------------------------------------------------------------------------*/
AITeamMove *aimCreateMoveToNoAdd(AITeam *team, vector destination, real32 limiter, udword type, TypeOfFormation formation, TacticsType tactics, bool_t wait, bool_t remove)
{
...
AITeamMove *aimCreateMoveTo(AITeam *team, vector destination, real32 limiter, udword type, TypeOfFormation formation, TacticsType tactics, bool_t wait, bool_t remove)
{
    AITeamMove *newMove;
...
/*-----------------------------------------------------------------------------
    ...
    Return      : The new move
----------------------------------------------------------------------------*/
AITeamMove *aimCreateMoveAttackNoAdd(AITeam *team, SelectCommand *targets, bool_t Advanced, TypeOfFormation formation, TacticsType tactics, bool8 wait, bool8 remove)
{
    AITeamMove *newMove;
...
AITeamMove *aimCreateMoveAttack(AITeam *team, SelectCommand *targets, bool_t Advanced, TypeOfFormation formation, TacticsType tactics, bool8 wait, bool8 remove)
{
    AITeamMove *newMove;
...
/*-----------------------------------------------------------------------------
    ...
    Return      : the new move
----------------------------------------------------------------------------*/
AITeamMove *aimCreateActiveReconNoAdd(AITeam *team, bool_t EnemyRecon, TypeOfFormation formation,
...
AITeamMove *aimCreateActiveRecon(AITeam *team, bool_t EnemyRecon, TypeOfFormation formation,
                                 TacticsType tactics, bool8 wait, bool8 remove)
{
    AITeamMove *newMove;
