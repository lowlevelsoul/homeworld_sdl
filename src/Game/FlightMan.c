...
typedef bool_t (*FlightmanSpecificExecute) (Ship *ship);
...
bool_t flightmanPitchDown(Ship *ship,real32 *totalAngleRotated,real32 degreesToRotate,real32 maxrotspeed,real32 rotaccelmodifier)
{
...
bool_t flightmanPitchUp(Ship *ship,real32 *totalAngleRotated,real32 degreesToRotate,real32 maxrotspeed,real32 rotaccelmodifier)
{
    real32 rotspeedy = ship->rotinfo.rotspeed.y;
    *totalAngleRotated += universe.phystimeelapsed * rotspeedy;
...
bool_t flightmanRollRight(Ship *ship,real32 *totalAngleRotated,real32 degreesToRotate,real32 maxrotspeed,real32 rotaccelmodifier)
{
...
bool_t flightmanRollLeft(Ship *ship,real32 *totalAngleRotated,real32 degreesToRotate,real32 maxrotspeed,real32 rotaccelmodifier)
{
    real32 rotspeedz = ship->rotinfo.rotspeed.z;
    *totalAngleRotated += universe.phystimeelapsed * rotspeedz;
...
bool_t flightmanYawRight(Ship *ship,real32 *totalAngleRotated,real32 degreesToRotate,real32 maxrotspeed,real32 rotaccelmodifier)
{
...
bool_t flightmanYawLeft(Ship *ship,real32 *totalAngleRotated,real32 degreesToRotate,real32 maxrotspeed,real32 rotaccelmodifier)
{
    real32 rotspeedx = ship->rotinfo.rotspeed.x;
    *totalAngleRotated += universe.phystimeelapsed * rotspeedx;
...
bool_t flightmanStabilizePitch(Ship *ship)
{
...
bool_t flightmanStabilizeRoll(Ship *ship)
{
    ShipStaticInfo *shipstaticinfo = (ShipStaticInfo *)ship->staticinfo;
    real32 rotspeedz = ship->rotinfo.rotspeed.z;
    real32 rotstr;
...
bool_t flightmanStabilizeYaw(Ship *ship)
{
    ShipStaticInfo *shipstaticinfo = (ShipStaticInfo *)ship->staticinfo;
    real32 rotspeedx = ship->rotinfo.rotspeed.x;
    real32 rotstr;
...
bool_t flightmanDoNothingExecute(Ship *ship)
{
...
bool_t flightmanFlipTurnExecute(Ship *ship)
{
    FlipTurnInfo *flipturninfo;
...
bool_t flightmanCorkscrewExecute(Ship *ship)
{
    CorkscrewInfo *corkscrewinfo;
...
bool_t flightmanImmelmanExecute(Ship *ship)
{
    ImmelmanInfo *immelmaninfo;
    bool_t result;
...
bool_t flightmanSplitSExecute(Ship *ship)
{
    SplitSInfo *splitsinfo;
    bool_t result;
...
bool_t flightmanHardBankExecute(Ship *ship)
{
    HardBankInfo *hardbankinfo;
    bool_t result;
...
bool_t flightmanSoftBankExecute(Ship *ship)
{
    SoftBankInfo *softbankinfo;
    bool_t result;
...
bool_t flightmanSlalomExecute(Ship *ship)
{
    SlalomInfo *slalominfo;
    vector *curwaypoint;
...
bool_t flightmanSandwichExecute(Ship *ship)
{
...
bool_t flightmanBarrelRollExecute(Ship *ship)
{
    RollInfo *barrelrollinfo;
...
bool_t flightmanSwarmerBRollExecute(Ship *ship)
{
    RollInfo *sbrollinfo;
...
bool_t flightmanRoll180Execute(Ship *ship)
{
    RollInfo *rollinfo;
...
bool_t flightmanBRollOutExecute(Ship *ship)
{
    RollInfo *rollinfo;
...
bool_t flightmanEndoverExecute(Ship *ship)
{
    EndoverInfo *rollinfo;
...
bool_t flightmanCelebFlipExecute(Ship *ship)
{
    RollInfo *cfinfo;
...
bool_t flightmanWhipStrafeExecute(Ship *ship)
{
    WhipStrafeInfo *whipstrafeinfo;
    ShipStaticInfo *shipstaticinfo = (ShipStaticInfo *)ship->staticinfo;
...
bool_t flightmanRollAwayExecute(Ship *ship)
{
    RollAwayInfo *rollawayinfo;
    bool_t result;
...
bool_t flightmanSplitSEvasiveExecute(Ship *ship)
{
    SplitSEvasiveInfo *splitsevasiveinfo;
    bool_t result;
...
bool_t flightmanHiYoYoExecute(Ship *ship)
{
    HiYoYoInfo *hiyoyoinfo;
...
bool_t flightmanLoYoYoExecute(Ship *ship)
{
    LoYoYoInfo *loyoyoinfo;
...
bool_t flightmanSideStepExecute(Ship *ship)
{
    SideStepInfo *sidestepinfo;
    bool_t result;
    bool_t pitchresult;
...
bool_t flightmanExecute(Ship *ship)
{
    dbgAssertOrIgnore(ship->flightman < NUM_FLIGHTMANEUVERS);
    if (ship->flightman == FLIGHTMAN_NULL)
    {
...
bool_t flightmanTestRandom(FlightManProb *prob,udword flightmanSubtype,udword flightman)
{
    udword sumtotal;
    udword randnum;
