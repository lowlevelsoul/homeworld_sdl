...
bool_t spDescriptionShadow = FALSE;                      //print with a dropshadow?
...
bool_t spSelectionValid(sdword candidate)
{
...
{
    sdword i;
    bool_t foundBitmap = FALSE, foundText = FALSE;
