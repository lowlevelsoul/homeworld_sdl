...
/*-----------------------------------------------------------------------------
    ...
    Return      : void
----------------------------------------------------------------------------*/
void aitDestroy(struct AIPlayer *aiplayer, AITeam *team, bool_t removeAllReferencesToTeam)
{
    sdword i = 0;
    sdword foundteam = -1;
...
----------------------------------------------------------------------------*/
bool_t aitCheckForLeaderAndMoveToFront(AITeam *team)
{
    ShipPtr ship;
    udword i;
...
----------------------------------------------------------------------------*/
bool_t aitCheckAmIBeingWatched(AITeam *team, SelectCommand *sel)
{
...
/*-----------------------------------------------------------------------------
    ...
    Return      : void
----------------------------------------------------------------------------*/
bool_t aitAllDefenseSwarmersFull(void)
{
    udword i;
...
//
bool_t aitRemoveShip(AITeam *team, ShipPtr ship)
{
...
bool_t aitTeamIsDone(AITeam *team)
{
...
----------------------------------------------------------------------------*/
bool_t aitTeamIsIdle(AITeam *team)
{
...
----------------------------------------------------------------------------*/
bool_t aitTeamIsGuarding(AITeam *team)
{
...
----------------------------------------------------------------------------*/
bool_t aitTeamIsAttacking(AITeam *team)
{
    AIMoveTypes moveType;
...
----------------------------------------------------------------------------*/
bool_t aitTeamIsntDefendingMothership(AITeam *team, SelectCommand *enemyships)
{
    if (team->curMove != NULL)
    {
...
----------------------------------------------------------------------------*/
bool_t aitTeamIsFinishedMoving(AITeam *team, vector destination, real32 range)
{
...
----------------------------------------------------------------------------*/
bool_t aitTeamIsDoingSpecialOp(AITeam *team)
{
...
bool_t aitAnyTeamOfPlayerAttackingThisShip(struct AIPlayer *aiplayer,Ship *ship)
{
    sdword i;
    Node *node;
    AITeamMove *move;
...
----------------------------------------------------------------------------*/
bool_t aitTeamIsInRange(AITeam *team, ShipPtr ship, real32 time)
{
...
/*-----------------------------------------------------------------------------
    ...
    Return      : TRUE if the team is in range
----------------------------------------------------------------------------*/
bool_t aitTeamIsInMothershipRange(AITeam *team)
{
...
----------------------------------------------------------------------------*/
bool_t aitNeedStrikeSupport(udword minstr)
{
    udword tally = 0, i;
    AITeam *team;
...
----------------------------------------------------------------------------*/
bool_t aitCheckIfOtherDefTeamAnsweringSignalNeedsHelp(AITeam *team, SelectCommand *ships)
{
    udword i;
    AITeamMove *move;
...
----------------------------------------------------------------------------*/
bool_t aitTeamHomogenous(AITeam *team)
{
...
----------------------------------------------------------------------------*/
bool_t aitTeamIsntCoopWithAnotherTeam_Cloak(AITeam *testteam)
{
    udword i;
    AITeam *team;
...
/*-----------------------------------------------------------------------------
    ...
    Return      : TRUE if the team isn't cooperating with another cloak team
----------------------------------------------------------------------------*/
bool_t aitTeamIsntCoopWithAnotherTeam_GravWell(AITeam *testteam)
{
    udword i;
    AITeam *team;
