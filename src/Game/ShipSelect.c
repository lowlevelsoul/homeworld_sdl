...
/*-----------------------------------------------------------------------------
    ...
    Return      :
----------------------------------------------------------------------------*/
bool_t RemoveSpaceObjFromSelectionPreserveOrder(SpaceObjSelection *selection,SpaceObj *obj)
{
    sdword i;
...
----------------------------------------------------------------------------*/
bool_t clRemoveTargetFromSelection(SelectAnyCommand *selection,TargetPtr removeTargetPtr)
{
    sdword i;
    bool_t removedAny = FALSE;
...
/*-----------------------------------------------------------------------------
    ...
    Return      :
----------------------------------------------------------------------------*/
bool_t ShipInSelection(SelectCommand *selection,Ship *ship)
{
    sdword i;
...
----------------------------------------------------------------------------*/
bool_t AnyOfTheseShipsAreInSelection(SelectCommand *theseShips,SelectCommand *selection)
{
    sdword i,j;
    ShipPtr thisShip;
...
----------------------------------------------------------------------------*/
bool_t TheseShipsAreInSelection(SelectCommand *theseShips,SelectCommand *selection)
{
    sdword i;
...
----------------------------------------------------------------------------*/
bool_t SelectionsAreEquivalent(SelectCommand *selection1,SelectCommand *selection2)
{
    sdword i,j;
...
----------------------------------------------------------------------------*/
bool_t SelectionsAreTotallyEquivalent(SelectCommand *selection1,SelectCommand *selection2)
{
    sdword numShips = selection1->numShips;
    sdword i;
...
----------------------------------------------------------------------------*/
bool_t isShipAttackCapable(Ship *ship)
{
...
----------------------------------------------------------------------------*/
bool_t AreAllShipsAttackCapable(SelectCommand *selection)
{
    sdword i;
...
----------------------------------------------------------------------------*/
bool_t AreAnyShipsAttackCapable(SelectCommand *selection)
{
    sdword i;
    ShipStaticInfo *shipstatic;
...
/*-----------------------------------------------------------------------------
    ...
    Return      : returns TRUE if ship is attack capable
----------------------------------------------------------------------------*/
bool_t isShipPassiveAttackCapable(Ship *ship)
{
...
/*-----------------------------------------------------------------------------
    ...
    Return      : returns TRUE if all ships are attack capable
----------------------------------------------------------------------------*/
bool_t AreAllShipsPassiveAttackCapable(SelectCommand *selection)
{
    sdword i;
    ShipStaticInfo *shipstatic;
...
/*-----------------------------------------------------------------------------
    ...
    Return      : returns TRUE if any ships are attack capable
----------------------------------------------------------------------------*/
bool_t AreAnyShipsPassiveAttackCapable(SelectCommand *selection)
{
    sdword i;
    ShipStaticInfo *shipstatic;
...
----------------------------------------------------------------------------*/
bool_t ShipCanHarvest(ShipStaticInfo *shipstatic)
{
...
----------------------------------------------------------------------------*/
bool_t ShipCanGuard(ShipStaticInfo *shipstatic)
{
...
/*-----------------------------------------------------------------------------
    ...
    Return      :
----------------------------------------------------------------------------*/
void MakeShipsSpecialTargetCapable(SelectCommand *selection, bool_t bFriendlies)
{
    sdword i;
    ShipStaticInfo *shipstatic;
...
bool_t AreShipsMobile(SelectCommand *selection)
{
    sdword i;
    ShipStaticInfo *shipstatic;
...
----------------------------------------------------------------------------*/
bool_t DoAllShipsFollowConstraints(SelectCommand *selection,ShipConstraintsCB shipConstraintsCB)
{
    sdword i;
...
----------------------------------------------------------------------------*/
bool_t DoAnyShipsFollowConstraints(SelectCommand *selection,ShipConstraintsCB shipConstraintsCB)
{
    sdword i;
...
bool_t growSelectRemoveShip(GrowSelection *growSelect,Ship *ship)
{
...
bool_t MakeSelectionKamikazeCapable(SelectCommand *selection)
{
    sdword i;
