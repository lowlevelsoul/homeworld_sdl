...
bool_t tbDisable = FALSE;

bool_t tbForceTaskbarVar = FALSE;

bool_t tbTaskBarActive = FALSE;
//bool_t mommyblink;
...
bool_t tbRefreshBabyFunction(udword num, void *data, struct BabyCallBack *baby);
