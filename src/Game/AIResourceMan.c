...
----------------------------------------------------------------------------*/
bool_t airShipDied(AIPlayer *aiplayer,ShipPtr ship)
{
...
bool_t FindBestPlaceForAdvanceSupportFrigate(vector *destination)
{
...
----------------------------------------------------------------------------*/
bool_t aiuCanBuildShipType(ShipType shiptype,bool_t scriptteam)
{
...
----------------------------------------------------------------------------*/
bool_t airDumbResourcerRequests(void)
{
...
----------------------------------------------------------------------------*/
bool_t airDumbResearchRequests(bool_t *requestedResearch)
{
...
/*-----------------------------------------------------------------------------
    ...
    Return      : Whether or not a new research ship has been requested at high priority
----------------------------------------------------------------------------*/
bool_t airSmartResearchRequests(bool_t *requestedResearch)
{
...
void airResourceManager(void)
{
    ...
    bool_t requestedSomething = FALSE, requestedResearch = FALSE;
